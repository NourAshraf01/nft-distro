...
const Accordion = ({ title, content }: AccordionProps) => {
    ...
    return (<>
        <div className="w-full relative flex flex-col max-w-[81rem] gap-[2rem]">
            <div className="w-full rounded-[16px] card-shadow dark:shadow-none bg-white dark:bg-[#333333] title-4 flex items-center place-content-between p-[20px]" onClick={() => { setIsOpen(open => !open) }}>
