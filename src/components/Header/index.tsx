...
const Nav = () => {
    ...
    return (<>
        <div className="flex items-center w-full place-content-between">
            <div className="text-[#B7B7B7] fill-[#B7B7B7] dark:text-grey_milk_weight-dark dark:fill-grey_milk_weight-dark w-fit bg-[#F3F3F3] rounded-[20px] flex px-[19px] py-[13px] gap-[16px] items-center title-3">
                <Search />
                <input value={''}  placeholder="Search"  className="bg-transparent outline-none border-none w-fit"/>
            </div>
